...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('homepage/vendors/owl-carousel/css/owl.carousel.min.css') }}">
    <link rel="stylesheet" href="{{ asset('homepage/vendors/owl-carousel/css/owl.theme.default.css') }}">
    <link rel="stylesheet" href="{{ asset('homepage/vendors/mdi/css/materialdesignicons.min.css') }}">
    <link rel="stylesheet" href="{{ asset('homepage/vendors/aos/css/aos.css') }}">
    <link rel="stylesheet" href="{{ asset('homepage/css/style.min.css') }}">
</head>
...
<body id="body" data-spy="scroll" data-target=".navbar" data-offset="100">
                ...
                <div class="collapse navbar-collapse navbar-menu-wrapper" id="navbarSupportedContent">
                    <ul class="navbar-nav align-items-lg-center align-items-start ml-auto">
                        ...
                        <li class="nav-item btn-contact-us pl-4 pl-lg-0">
                            <button class="btn btn-dark text-warning" data-toggle="modal"
                        ...
                        <div class="modal-body">
                            ...
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="password" type="password" id="Name"
    ...
    <script src="{{ asset('homepage/vendors/jquery/jquery.min.js') }}"></script>
    <script src="{{ asset('homepage/vendors/bootstrap/bootstrap.min.js') }}"></script>
    <script src="{{ asset('homepage/vendors/owl-carousel/js/owl.carousel.min.js') }}"></script>
    <script src="{{ asset('homepage/vendors/aos/js/aos.js') }}"></script>
    <script src="{{ asset('homepage/js/landingpage.js') }}"></script>
</body>
